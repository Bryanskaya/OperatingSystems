...
> **Асинхронный** ввод-вывод (AIO) - процесс не блокируется до завершения операции, он продолжает выполнять свой код и можно позже проверить статус поданного запроса. Для
