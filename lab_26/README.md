...
> **Асинхронный** ввод-вывод (AIO) (**неблокирующий асинхронный**) - процесс не блокируется до завершения операции, он продолжает выполнять свой код и можно позже проверить статус поданного запроса. Для
завершения транзакции ввода-вывода может использоваться сигнал, на который устанавливается обработчик сигнала.  
